...
const spentMon = document.querySelector(
  ".dashboard__chart__bars__bar__spent-mon"
);
const spentTue = document.querySelector(
  ".dashboard__chart__bars__bar__spent-tue"
);
const spentWed = document.querySelector(
  ".dashboard__chart__bars__bar__spent-wed"
);
const spentThu = document.querySelector(
  ".dashboard__chart__bars__bar__spent-thu"
);
const spentFri = document.querySelector(
  ".dashboard__chart__bars__bar__spent-fri"
);
const spentSat = document.querySelector(
  ".dashboard__chart__bars__bar__spent-sat"
);
const spentSun = document.querySelector(
  ".dashboard__chart__bars__bar__spent-sun"
);
...
const getBarHeight = spendings => {
  ...
  for (const day of spendings) {
    // using an ES6 for loop to calculate each value
